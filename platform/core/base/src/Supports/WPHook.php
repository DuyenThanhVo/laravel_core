 ...
 * @see ArrayAccess
 */
final class WPHook implements Iterator, ArrayAccess {
    ...
    /**
     * Normalizes filters set up before WordPress has initialized to WPHook objects.
     *
     * @since 4.7.0
     *
     * @param array $filters Filters to normalize.
     * @return WPHook[] Array of normalized filters.
     */
    public static function build_preinitialized_hooks( $filters ) {
        /** @var WPHook[] $normalized */
        $normalized = array();

        foreach ( $filters as $tag => $callback_groups ) {
            if ( is_object( $callback_groups ) && $callback_groups instanceof WPHook ) {
